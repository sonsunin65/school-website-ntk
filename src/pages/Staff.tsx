...
const teachingStaff = [
  ...
  {
    name: 'นางสาวนงค์ลักษณ์ พรหมนัด',
    position: 'หัวหน้ากลุ่มสาระการเรียนภาษาต่างประเทศ',
    subject: 'ภาษาอังกฤษ',
    education: 'ปริญญาโท บริหารการศึกษา',
    experience: '12 ปี',
  ...
  {
    name: 'นางสาวเบญจมาภรณ์ กาญจนฤทธากรณ์',
    position: 'กลุ่มงานงบประมาณ',
    subject: 'คณิตศาสตร์',
    education: 'ปริญญาโท คณิตศาสตร์',
    experience: '6 ปี',
    color: 'from-blue-500 to-blue-400',
  },
  {
    name: 'นางสาวธารารัตน์ อิศนพงษ์',
    position: 'กลุ่มงานงบประมาณ',
    subject: 'ภาษาอังกฤษ',
    education: 'ปริญญาตรี ภาษาอังกฤษ',
    experience: '3 ปี',
    color: 'from-green-500 to-green-400',
  },
  {
    name: 'นางสาวบัณฑิตา พวงไพบูลย์',
    position: 'กลุ่มบริหารงานบุคคล',
    subject: 'สังคมศึกษา',
    education: 'ปริญญาตรี สังคมศึกษา',
    experience: '20 ปี',
    color: 'from-purple-500 to-purple-400',
  },
  {
    name: 'นางสุรินธร เกื้อประโคน',
    position: 'กลุ่มบริหารทั่วไป',
    subject: 'แนะแนว',
    education: 'ปริญญาตรี แนะแนว',
    experience: '25 ปี',
    color: 'from-red-500 to-red-400',
  },
  {
    name: 'นางสาวจิราวดี ไชยศรีรัมย์',
    position: 'กลุ่มบริหารทั่วไป',
    subject: 'ภาษาไทย',
    education: 'ปริญญาตรี ภาษาไทย',
    experience: '15 ปี',
    color: 'from-orange-500 to-orange-400',
  },
  {
    name: 'นางสาววิลาวรรณ ทองเรียม',
    position: 'กลุ่มบริหารทั่วไป',
    subject: 'ปฐมวัย',
    education: 'ปริญญาตรี ปฐมวัย',
    experience: '6 ปี',
    color: 'from-teal-500 to-teal-400',
  },
  {
    name: 'นางสุมาลี ใจกล้า',
    position: 'กลุ่มบริหารทั่วไป',
    subject: 'ครูพี่เลี้ยงเด็กพิการ',
    education: 'ปริญญาตรี สังคมศึกษา',
    experience: '20 ปี',
    color: 'from-indigo-500 to-indigo-400',
  },
  {
    name: 'นางสาวณัฏฐา ชาวประโคน',
    position: 'กลุ่มบริหารทั่วไป',
    subject: 'ธุรการโรงเรียน',
    education: 'ปริญญาโท',
    experience: '6 ปี',
    color: 'from-teal-500 to-teal-400',
  },
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-primary-foreground/80 text-lg">
                ครูและบุคลากรที่มีความเชี่ยวชาญและทุ่มเทในการพัฒนานักเรียน
              </p>
            </div>
          </div>
        </section>
